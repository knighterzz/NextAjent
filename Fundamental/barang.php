...
<html lang="en">
  <head>
    ...
    <title>Fundamental - Barang</title>
  </head>
  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
         ...
         <a href="databarang.php" class="btn btn-primary mb-3"><i class="fas fa-user-plus mr-2"></i>TAMBAH DATA BARANG</a>
         <table class="table table-striped table-bordered text-center">
			...
			<tbody>
				<?php
					$rs = mysqli_query($con, "SELECT * FROM barang");
