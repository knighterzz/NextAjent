...
<html lang="en">
  <head>
    ...
    <title>Fundamental - Transaksi</title>
  </head>
  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
         <h3><i class="fas fa-credit-card mr-3"></i>Transaksi</h3><hr>
         <a href="" class="btn btn-primary mb-3"><i class="fas fa-user-plus mr-2"></i>Import Transaksi</a>
         <table class="table table-striped table-bordered text-center">
            ...
            <tbody>   
				<?php
					$rs = mysqli_query($con, "SELECT faktur, menu.nama, transaksi.jumlah_barang, menu.harga , jenis_member.diskon_member, IF(jenis_member.diskon_member>0, (transaksi.jumlah_barang*menu.harga)-(jenis_member.diskon_member/100*transaksi.jumlah_barang*menu.harga), transaksi.jumlah_barang*menu.harga), transaksi.tanggal, transaksi.metode_pembayaran FROM transaksi JOIN menu ON (transaksi.id_menu = menu.id) JOIN jenis_member ON (transaksi.diskon = jenis_member.id) ORDER BY transaksi.tanggal DESC");
