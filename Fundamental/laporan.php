  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
         <h3><i class="fas fa-book mr-3"></i>LAPORAN</h3><hr>
         <div class="row text-white">
           <h5>Kritik dan Saran</h5><hr>
            ...
            <tbody>
              <tr>
                <th scope="row">1</th>
                <td>BAKAR@GMAIL.COM</td>
                <td>BROBRO</td>
                <td><i class="fas fa-user-edit bg-success p-3 text-white rounded" data-toggle="tooltip" title="Ubah"></i></td>
                <td><i class="fas fa-user-times bg-danger p-3 text-white rounded" data-toggle="tooltip" title="hapus"></i></td>
              </tr>
              <tr>
               <th scope="row">2</th>
               <td>SUPJIMEN</td>
