...
<html lang="en">
  <head>
    ...
    <title>Fundamental - Pegawai</title>
  </head>
  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
         <h3><i class="fas fa-address-card mr-3"></i>Data Pegawai</h3><hr>
         <a href="regpekerja.php" class="btn btn-primary mb-3"><i class="fas fa-user-plus mr-2"></i>TAMBAH DATA PEGAWAI</a>
         <table class="table table-striped table-bordered text-center">
			...
			<tbody>
				<?php
					$rs = mysqli_query($con, "SELECT * FROM pegawai");
